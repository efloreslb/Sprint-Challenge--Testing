...
1. In Jest, what are the differences between `describe()` and `it()` globals, and what are good uses for them?
   - 'describe()' is used to test a component by grouping individual 'it() statements, which are used to test the component in detail'
1. What is the point of `Test Driven Development`? What do you think about this approach?
   - The purpose of TDD is to develop with the end goal in mind. This approach ensures that we think of the final expectation and then build the code to match the expectation.
